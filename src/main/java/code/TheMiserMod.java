...
public class TheMiserMod implements
    ...
    public static final String modID = "themiser"; //TODO: Change this.
    ...
    public TheMiserMod() {
        ...
        BaseMod.addColor(TheMiser.Enums.GOLD_COLOR, characterColor, characterColor, characterColor,
    ...
    public static void initialize() {
        TheMiserMod thismod = new TheMiserMod();
    }

    @Override
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new TheMiser(TheMiser.characterStrings.NAMES[1], TheMiser.Enums.THE_MISER),
                CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, TheMiser.Enums.THE_MISER);
