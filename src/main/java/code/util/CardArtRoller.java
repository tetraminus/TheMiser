...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(TheMiserMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(TheMiserMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(TheMiserMod.makeImagePath("masks/PowerMask.png"));
