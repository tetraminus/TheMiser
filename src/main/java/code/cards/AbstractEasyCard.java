...
import static code.TheMiserMod.makeImagePath;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    private boolean upgradesGoldCost = false;
    private int goldCostUpgrade;
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, TheMiser.Enums.GOLD_COLOR);
    }
    ...
    protected void setGoldCost(int base, int up) {
        setGoldCost(base);
        upgradedGoldCost = true;
        goldCostUpgrade = up;
    }

    protected void setGoldCost(int base) {
        baseGoldCost = goldCost = base;
    }
    ...
    public void upp() {
        ...
        if (upgradesGoldCost)
            upgradeGoldCost(goldCostUpgrade);
        if (upgradesCost)
    ...
    public AbstractCard makeStatEquivalentCopy() {
        ...
        c.baseGoldCost = c.goldCost = baseGoldCost;
        return c;
    }
    ...
    protected void gainGold() {
        atb(new GoldAction(goldCost));
    }

    protected void loseGold() {
        atb(new GoldAction(goldCost, false));
    }

    protected boolean hasGold() {
        return AbstractDungeon.player.gold >= goldCost;
    }
    ...
    protected void upGoldCost(int x) {
        upgradeGoldCost(x);
    }
}
