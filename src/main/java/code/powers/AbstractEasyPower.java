...
public abstract class AbstractEasyPower extends AbstractPower {
    ...
    public AbstractEasyPower(String ID, String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        ...
        Texture normalTexture = TexLoader.getTexture(TheMiserMod.modID + "Resources/images/powers/" + ID.replaceAll(TheMiserMod.modID + ":", "") + "32.png");
        Texture hiDefImage = TexLoader.getTexture(TheMiserMod.modID + "Resources/images/powers/" + ID.replaceAll(TheMiserMod.modID + ":", "") + "84.png");
        if (hiDefImage != null) {
