...
public class DemoPotion extends AbstractEasyPotion {
    ...
    public DemoPotion() {
        super(ID, PotionRarity.COMMON, PotionSize.ANVIL, new Color(0.2f, 0.4f, 0.9f, 1f), new Color(0.6f, 0.8f, 1.0f, 1f), null, TheMiser.Enums.THE_MISER, TheMiserMod.characterColor);
    }
