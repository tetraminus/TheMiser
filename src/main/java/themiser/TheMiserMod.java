...
import themiser.util.GeneralUtils;
import themiser.util.KeywordInfo;
import themiser.util.TextureLoader;
...
@SpireInitializer
public class TheMiserMod implements
    ...
    private static final String resourcesFolder = "themiser";
    ...
    private static final Color cardColor = new Color(218f/255f, 165f/255f, 32f/255f, 1f);
    ...
    public static void initialize() {
        ...
        BaseMod.addColor(TheMiser.Enums.CARD_COLOR, cardColor,
    ...
    public void receivePostInitialize() {
        ...
        BaseMod.addPower(HoldsGoldPower.class, HoldsGoldPower.ID);
    }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(TheMiserMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new TheMiser(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT, TheMiser.Enums.THE_MISER);
    }
