...
import static themiser.TheMiserMod.characterPath;
import static themiser.TheMiserMod.makeID;

public class TheMiser extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("TheMiser"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_MISER;

        @SpireEnum(name = "MISER_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "MISER_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public TheMiser() {
        super(NAMES[0], Enums.THE_MISER,
                new CustomEnergyOrb(null, null, null), //Energy Orb
                new SpineAnimation(characterPath("animation/MiserAnims.atlas"), characterPath("animation/MiserAnims.json"), 1F)); //Animations
    ...
    private final Color cardRenderColor = Color.GOLD.cpy(); //Used for some vfx on moving cards (sometimes) (maybe)
    private final Color cardTrailColor = Color.GOLD.cpy(); //Used for card trail vfx during gameplay.
    private final Color slashAttackColor = Color.GOLD.cpy(); //Used for a screen tint effect when you attack the heart.
    @Override
    ...
    public static HashMap<RewardItem.RewardType, Integer> RewardCosts = new HashMap<>();
    public static ArrayList<RewardItem.RewardType> OneTimeRewards = new ArrayList<>();

    static {
        RewardCosts.put(RewardItem.RewardType.CARD, 50);
        RewardCosts.put(RewardItem.RewardType.POTION, 50);
        RewardCosts.put(RewardItem.RewardType.RELIC, 100);

        OneTimeRewards.add(RewardItem.RewardType.CARD);
    }
